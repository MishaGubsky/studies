function [Apass,Astop,wmax,An]=viewspi(Fmax,m,b,Fs)
% [Apass,Astop,wmax,An]=viewspi(Fmax,m,b,Fs)
%   Survey of spectra at an interpolation b-spline
%   Fmax   Upper frequency of a signal (Hz)
%   m      Magnification of frequency (integer)
%   b      B-spline length 4*m
%   Fs     Sampling rate               (Hz)         
